"""
core/medical_vocab.py
=====================
Vocabulaire médical extrait des vrais comptes rendus radiologiques +
enrichi par catégorie. Utilisé pour corriger la transcription Faster-Whisper.
"""
...
# (ce que Whisper transcrit souvent mal → terme correct)
# ═══════════════════════════════════════════════════════════════════════════════
...
def apply_phonetic_corrections(text: str) -> str:
    """Applique les corrections phonétiques sur un texte transcrit par Whisper."""
    import re
    result = text
